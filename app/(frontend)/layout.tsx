      ...
      <body className="bg-paper text-light font-body text-lg leading-8 min-h-screen m-0">
        <nav className="sticky top-0 z-100 bg-black/95 backdrop-blur-xl border-b border-rule">
          <div className="max-w-5xl mx-auto px-8 py-3 flex items-center justify-between">
            <a href="/" className="font-mono text-sm font-bold text-light tracking-tight no-underline">
            ...
            <div className="flex items-center gap-5">
              ...
              <a href="/admin" className="font-mono text-[0.6rem] font-medium uppercase tracking-[0.12em] text-dim no-underline hover:text-white transition-colors">Admin</a>
              <a href="https://payloadcms.com/docs" target="_blank" rel="noopener noreferrer" className="font-mono text-[0.6rem] font-medium uppercase tracking-[0.12em] text-dim no-underline hover:text-white transition-colors">Docs</a>
            </div>
          </div>
        </nav>
        <main>{children}</main>
        <footer className="border-t border-rule px-8 py-5 mt-24">
          <div className="max-w-5xl mx-auto flex items-center justify-between">
            ...
            <a href="/admin" className="font-mono text-[0.6rem] font-medium uppercase tracking-[0.12em] text-dim no-underline hover:text-white transition-colors">Admin &rarr;</a>
          </div>
        </footer>
      </body>
    </html>
