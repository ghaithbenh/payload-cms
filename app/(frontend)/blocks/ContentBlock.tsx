...
type ContentBlockData = Extract<BlockData, { blockType: 'content' }>

export function ContentBlock({ block: rawBlock }: { block: BlockData }) {
  const block = rawBlock as ContentBlockData
  return (
